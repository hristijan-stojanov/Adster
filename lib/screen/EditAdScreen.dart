...
class EditAdForm extends StatefulWidget {
  final Ad ad;
  EditAdForm({ required this.ad });

  @override
  _AdFormState createState() => _AdFormState();
}

class _AdFormState extends State<EditAdForm> {
  ...
  void initState() {
    ...
    if (widget.ad != null) {
      ...
      isExchangePossible = widget.ad.isExchangePossible;
      isDeliveryPossible = widget.ad.isDeliveryPossible;
